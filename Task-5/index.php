...
$mostProduct = $product->mostOrderProduct();
$topRate = $product->topRate();
?>
<!-- header end -->
<!-- Slider Start -->
...
<!-- New Products End -->
<!-- Product Top View Start -->
<div class="product-area gray-bg pt-90 pb-65">
    <div class="container">
        <div class="product-top-bar section-border mb-55">
            <div class="section-title-wrap text-center">
                <h3 class="section-title">Top Rate</h3>
            </div>
        </div>
        <div class="grid-list-product-wrapper">
            <div class="product-grid product-view pb-20">
                <div class="row">
                    <?php
                    if ($topRate) {
                        $products = $topRate->fetch_all(MYSQLI_ASSOC);
                        // print_r($products);die;
                        foreach ($products as $key => $productValue) {
                    ?>
                            <div class="product-width col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 mb-30">
...
<!-- Product End -->
<!-- Most Order Product Start -->
<div class="product-area gray-bg pt-90 pb-65">
    <div class="container">
        <div class="product-top-bar section-border mb-55">
            <div class="section-title-wrap text-center">
                <h3 class="section-title">Must Order Products</h3>
            </div>
        </div>
        <div class="grid-list-product-wrapper">
            <div class="product-grid product-view pb-20">
                <div class="row">
                    <?php
                    if ($mostProduct) {
                        $products = $mostProduct->fetch_all(MYSQLI_ASSOC);
                        // print_r($products);die;
                        foreach ($products as $key => $productValue) {
                    ?>
                            <div class="product-width col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 mb-30">
