...
if ($_GET) {
  if (isset($_GET['sub'])) {
    if (is_numeric($_GET['sub'])) {
      $product->setSubcategorie_id($_GET['sub']);
      $productResult = $product->getProductBySub();
    } else {
      // header("location:layouts/errors/error.php");
      $productResult = $product->read(); // Get All Product
    }
  } else {
    $productResult = $product->read(); // Get All Product
  }
} else {
  $productResult = $product->read(); // IF Request post All shop
}
        ...
        <div class="grid-list-product-wrapper">
          <div class="product-grid product-view pb-20">
            <div class="row">
              ...
              ?>
                  <div class="product-width  col-lg-3 col-md-6 col-12 mb-30">
                    <div class="product-wrapper">
                      <div class="product-img">
                        <a href="product-details.php?id=<?php echo $productValue['id'] ?>">
                          <img alt="" src="assets/img/product/<?= $productValue['image'] ?>">
                        </a>
                      ...
                      <div class="product-content text-left">
                        <div class="product-hover-style">
                          <div class="product-title">
                            <h4>
                              <a href="product-details.php" ?id=<?php echo $productValue['id'] ?>><?= $productValue['name_en'] ?></a>
                            </h4>
                          </div>
                          <div class="cart-hover">
                            <h4><a href="product-details.php?id=<?php echo $productValue['id'] ?>">+ Add to cart</a></h4>
                          </div>
                        </div>
                        <div class="product-price-wrapper">
                          <span><?= $productValue['price'] ?> EGP</span>
                        </div>
                      </div>
                ...
                ?>
                <div class="alert alert-warning text-center w-100">No Products Yet</div>
              <?php
              }
              ?>
            </div>
              ...
              <ul id="faq">
                ...
                ?>
                    <li> <a data-toggle="collapse" data-parent="#faq" href="#shop-catigory-<?= $key ?>"><?= $category['name_en'] ?><i class="ion-ios-arrow-down"></i></a>
                      <ul id="shop-catigory-<?= $key ?>" class="panel-collapse collapsef">
                        <?php
